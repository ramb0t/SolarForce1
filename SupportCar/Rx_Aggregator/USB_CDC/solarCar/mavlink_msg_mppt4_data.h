...
#define MAVLINK_MSG_ID_MPPT4_DATA_LEN 8
#define MAVLINK_MSG_ID_154_LEN 8

#define MAVLINK_MSG_ID_MPPT4_DATA_CRC 237
#define MAVLINK_MSG_ID_154_CRC 237
...
#define MAVLINK_MESSAGE_INFO_MPPT4_DATA { \
	...
	{  { "voltage_in", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_mppt4_data_t, voltage_in) }, \
         ...
         { "voltage_out", NULL, MAVLINK_TYPE_UINT16_T, 0, 4, offsetof(mavlink_mppt4_data_t, voltage_out) }, \
         { "ambient_temp", NULL, MAVLINK_TYPE_UINT8_T, 0, 6, offsetof(mavlink_mppt4_data_t, ambient_temp) }, \
         { "status", NULL, MAVLINK_TYPE_UINT8_T, 0, 7, offsetof(mavlink_mppt4_data_t, status) }, \
         } \
}
...
{
	return mavlink_msg_mppt4_data_pack(system_id, component_id, msg, mppt4_data->voltage_in, mppt4_data->current_in, mppt4_data->voltage_out, mppt4_data->ambient_temp, mppt4_data->status);
}
...
{
	return mavlink_msg_mppt4_data_pack_chan(system_id, component_id, chan, msg, mppt4_data->voltage_in, mppt4_data->current_in, mppt4_data->voltage_out, mppt4_data->ambient_temp, mppt4_data->status);
}
...
static inline void mavlink_msg_mppt4_data_send(mavlink_channel_t chan, uint16_t voltage_in, uint16_t current_in, uint16_t voltage_out, uint8_t ambient_temp, uint8_t status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MPPT4_DATA_LEN];
	_mav_put_uint16_t(buf, 0, voltage_in);
 ...
 */
static inline void mavlink_msg_mppt4_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t voltage_in, uint16_t current_in, uint16_t voltage_out, uint8_t ambient_temp, uint8_t status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field voltage_out from mppt4_data message
 *
 * @return output voltage from MPPT (0mA-6.5535kA)
 */
static inline uint16_t mavlink_msg_mppt4_data_get_voltage_out(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  4);
}

/**
 * @brief Get field ambient_temp from mppt4_data message
 *
 * @return Ambient temperature
 */
static inline uint8_t mavlink_msg_mppt4_data_get_ambient_temp(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint8_t(msg,  6);
}

/**
 * @brief Get field status from mppt4_data message
 *
 * @return status flags
 */
static inline uint8_t mavlink_msg_mppt4_data_get_status(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mppt4_data_decode(const mavlink_message_t* msg, mavlink_mppt4_data_t* mppt4_data)
{
	...
	mppt4_data->voltage_out = mavlink_msg_mppt4_data_get_voltage_out(msg);
	mppt4_data->ambient_temp = mavlink_msg_mppt4_data_get_ambient_temp(msg);
	mppt4_data->status = mavlink_msg_mppt4_data_get_status(msg);
#else
