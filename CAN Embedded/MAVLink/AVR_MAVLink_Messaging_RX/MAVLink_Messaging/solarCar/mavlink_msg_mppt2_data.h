...
#define MAVLINK_MSG_ID_MPPT2_DATA_LEN 6
#define MAVLINK_MSG_ID_152_LEN 6

#define MAVLINK_MSG_ID_MPPT2_DATA_CRC 165
...
#define MAVLINK_MESSAGE_INFO_MPPT2_DATA { \
	...
	{  { "voltage_in", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_mppt2_data_t, voltage_in) }, \
         ...
         { "overtemp", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mppt2_data_t, overtemp) }, \
         { "undervolt", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_mppt2_data_t, undervolt) }, \
         } \
}
...
static inline void mavlink_msg_mppt2_data_send(mavlink_channel_t chan, uint16_t voltage_in, uint16_t current_in, uint8_t overtemp, uint8_t undervolt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MPPT2_DATA_LEN];
	_mav_put_uint16_t(buf, 0, voltage_in);
 ...
 */
static inline void mavlink_msg_mppt2_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint16_t voltage_in, uint16_t current_in, uint8_t overtemp, uint8_t undervolt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
