...
#define MAVLINK_MSG_ID_MPPT4_DATA_LEN 10
#define MAVLINK_MSG_ID_154_LEN 10

#define MAVLINK_MSG_ID_MPPT4_DATA_CRC 77
#define MAVLINK_MSG_ID_154_CRC 77
...
#define MAVLINK_MESSAGE_INFO_MPPT4_DATA { \
	"MPPT4_DATA", \
	4, \
	{  { "voltage_in", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_mppt4_data_t, voltage_in) }, \
         { "current_in", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_mppt4_data_t, current_in) }, \
         { "overtemp", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_mppt4_data_t, overtemp) }, \
         { "undervolt", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_mppt4_data_t, undervolt) }, \
         } \
}
...
static inline void mavlink_msg_mppt4_data_send(mavlink_channel_t chan, float voltage_in, float current_in, uint8_t overtemp, uint8_t undervolt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MPPT4_DATA_LEN];
	_mav_put_float(buf, 0, voltage_in);
 ...
 */
static inline void mavlink_msg_mppt4_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float voltage_in, float current_in, uint8_t overtemp, uint8_t undervolt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float mavlink_msg_mppt4_data_get_voltage_in(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_mppt4_data_get_current_in(const mavlink_message_t* msg)
{
