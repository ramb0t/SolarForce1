...
{
	return mavlink_msg_mppt1_data_pack(system_id, component_id, msg, mppt1_data->voltage_in, mppt1_data->current_in, mppt1_data->overtemp, mppt1_data->undervolt);
}
...
{
	return mavlink_msg_mppt1_data_pack_chan(system_id, component_id, chan, msg, mppt1_data->voltage_in, mppt1_data->current_in, mppt1_data->overtemp, mppt1_data->undervolt);
}
...
/**
 * @brief Get field overtemp from mppt1_data message
 *
...
/**
 * @brief Get field undervolt from mppt1_data message
 *
...
static inline void mavlink_msg_mppt1_data_decode(const mavlink_message_t* msg, mavlink_mppt1_data_t* mppt1_data)
{
	...
	mppt1_data->overtemp = mavlink_msg_mppt1_data_get_overtemp(msg);
	mppt1_data->undervolt = mavlink_msg_mppt1_data_get_undervolt(msg);
#else
