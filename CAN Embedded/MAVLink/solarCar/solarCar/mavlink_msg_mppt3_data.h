...
#define MAVLINK_MSG_ID_MPPT3_DATA_LEN 10
#define MAVLINK_MSG_ID_153_LEN 10

#define MAVLINK_MSG_ID_MPPT3_DATA_CRC 233
#define MAVLINK_MSG_ID_153_CRC 233
...
#define MAVLINK_MESSAGE_INFO_MPPT3_DATA { \
	"MPPT3_DATA", \
	4, \
	{  { "voltage_in", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_mppt3_data_t, voltage_in) }, \
         { "current_in", NULL, MAVLINK_TYPE_FLOAT, 0, 4, offsetof(mavlink_mppt3_data_t, current_in) }, \
         { "overtemp", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_mppt3_data_t, overtemp) }, \
         { "undervolt", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_mppt3_data_t, undervolt) }, \
         } \
}
...
{
	return mavlink_msg_mppt3_data_pack(system_id, component_id, msg, mppt3_data->voltage_in, mppt3_data->current_in, mppt3_data->overtemp, mppt3_data->undervolt);
}
...
{
	return mavlink_msg_mppt3_data_pack_chan(system_id, component_id, chan, msg, mppt3_data->voltage_in, mppt3_data->current_in, mppt3_data->overtemp, mppt3_data->undervolt);
}
...
static inline void mavlink_msg_mppt3_data_send(mavlink_channel_t chan, float voltage_in, float current_in, uint8_t overtemp, uint8_t undervolt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_MPPT3_DATA_LEN];
	_mav_put_float(buf, 0, voltage_in);
 ...
 */
static inline void mavlink_msg_mppt3_data_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float voltage_in, float current_in, uint8_t overtemp, uint8_t undervolt)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float mavlink_msg_mppt3_data_get_voltage_in(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_mppt3_data_get_current_in(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  4);
}

/**
 * @brief Get field overtemp from mppt3_data message
 *
 * @return Flag to indicate the MPPTs are over temperature ('1' = over temp; '0' = OK)
 */
static inline uint8_t mavlink_msg_mppt3_data_get_overtemp(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint8_t(msg,  8);
}

/**
 * @brief Get field undervolt from mppt3_data message
 *
 * @return Flag to indicate the MPPTs are under voltage ('1' = over temp; '0' = OK)
 */
static inline uint8_t mavlink_msg_mppt3_data_get_undervolt(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mppt3_data_decode(const mavlink_message_t* msg, mavlink_mppt3_data_t* mppt3_data)
{
	...
	mppt3_data->overtemp = mavlink_msg_mppt3_data_get_overtemp(msg);
	mppt3_data->undervolt = mavlink_msg_mppt3_data_get_undervolt(msg);
#else
